...
'''
    Filename: Find_my_weather.py
    Author: John Fuller
    Date created: 2/7/2021
    Date last modified: 2/7/2021
    Description:
        Provides the weather forecast for a city
        based on entered latitude and longitude.
'''
...
def main():
    while True:
        ...
        print("Provide coordinates in decimal notation.  Ex: 37.886, -78.894")
